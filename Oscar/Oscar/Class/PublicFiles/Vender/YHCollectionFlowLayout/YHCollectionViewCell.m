...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, IMAGEVIEW_ORIGIN_Y-self.frame.origin.y/kScreenHeight*IMAGEVIEW_MOVE_DISTANCE, kScreenWidth, CELL_CURRHEIGHT)];
        ...
        self.titleLabel.textColor = kColorFromRGB(0xFFFFFF);
        self.titleLabel.font = kFontTextPingFangSCMediumSize(22);
        ...
        self.descLabel.textColor = kColorFromRGBAlpha(0xFFFFFF, 0.5);
        self.descLabel.font = kFontTextPingFangSCRgularSize(14);
        ...
        self.bottomLabel.textColor = kColorFromRGBAlpha(0xFFFFFF, 0.5);
        self.bottomLabel.font = kFontTextPingFangSCRgularSize(14);
